...
class Students extends REST_Controller 
{
    ...
    public function index_get()
    {
        ...
        {
            $this->response(array('status' => 1, 'message' => 'students found', 'data' => $students_data), REST_Controller::HTTP_OK); // returns data(response) in json format
        }
        else
        {
            $this->response(array('status' => 0, 'message' => 'students data not found', 'data' => $students_data), REST_Controller::HTTP_NOT_FOUND);
        }
    }
         ...
         $this->set_response([
          ...
          else
          {
            $student_data = [
                ...
                {
                    $this->set_response(['status' => 1, 'message' => 'Student registered successfully']);
                }
          }
